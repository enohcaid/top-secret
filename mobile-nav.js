...
(function () {
  const PAGES = [
    ...
    { label: 'Conv.',     url: 'convocatoria.html?vista', svg: '<rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><path d="M8 12l3 3 5-5"/>' },
    ...
    { label: 'News',      url: 'noticias.html',    svg: '<path d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"/>' },
    { label: 'Plan',      url: 'plan-de-juego.html',  svg: '<rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0110 0v4"/>' },
    { label: 'Reclu.',   url: 'reclutamiento.html',  svg: '<path d="M16 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="8.5" cy="7" r="4"/><line x1="20" y1="8" x2="20" y2="14"/><line x1="23" y1="11" x2="17" y2="11"/>' },
  ];
  ...
  PAGES.forEach(p => {
    ...
    if (p.url.split('?')[0] === currentFile || (currentFile === '' && p.url === 'index.html')) {
