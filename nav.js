...
(function() {
  ...
  style.textContent = `
    ...
    #ts-nav .ts-logo{display:flex;align-items:center;gap:18px;text-decoration:none;flex-shrink:0;}
    #ts-nav .ts-logo img{width:32px;height:32px;object-fit:contain;filter:drop-shadow(0 0 6px rgba(200,168,75,.4));}
    #ts-nav .ts-logo span{font-family:'Bebas Neue',sans-serif;font-size:2.2rem;font-weight:400;letter-spacing:.1em;color:#f0f2f8;line-height:1;}
