...
const NOTICIAS = [
  ...
  },
  {
    ...
    body: [
      ...
      '<strong>Lautavester7 — el artillero que emergió en la recuperación.</strong> Con tres goles en las fechas del jueves, Lautavester7 se consolidó como el máximo artillero del torneo: cuatro goles en seis fechas. El primero lo había anotado en la victoria inaugural ante Vikings Team. Los siguientes tres llegaron en el momento de mayor presión, cuando el equipo más los necesitaba. J. Martinez y RS32DaniStone sumaron una asistencia cada uno en esta jornada, aportando el armado desde el mediocampo.',
